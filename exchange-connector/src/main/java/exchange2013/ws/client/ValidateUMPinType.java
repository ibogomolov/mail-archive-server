...
/**
 * <p>Java class for ValidateUMPinType complex type.
 * 
...
@XmlType(name = "ValidateUMPinType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "pinInfo",
    "userUMMailboxPolicyGuid"
})
public class ValidateUMPinType
