    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(exchange2013.ws.client.ExchangeServices.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = exchange2013.ws.client.ExchangeServices.class.getResource(".");
