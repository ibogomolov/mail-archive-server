...
@XmlSeeAlso({
    ...
    GetClientExtensionType.class,
    AddDistributionGroupToImListType.class,
    SendItemType.class,
    ValidateUMPinType.class,
    GetUMPinType.class,
    GetItemType.class,
